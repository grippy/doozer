...
* Some of the more useful Rails conventions and methodologies (mostly the application structure, configuration, nomenclature, scripts, and a few viewhelper methods).
...
2. Fire up the application in development mode=> 'script/cluster -C start'.
