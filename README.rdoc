...
3. Fire up the application in development mode=> 'script/cluster -C start'.
...
* Magic routes are turned off. These worked at one point. They may work again one day. Still debating adding them back.
